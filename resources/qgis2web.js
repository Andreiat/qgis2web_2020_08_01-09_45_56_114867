...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [4860233.672547, 7428181.893261, 4897049.108452, 7449195.594449], maxZoom: 18, minZoom: 8
    })
});
...
map.getView().fit([4860233.672547, 7428181.893261, 4897049.108452, 7449195.594449], map.getSize());
